...
1. GET Account Status & Order Management
    ...
    ☐ mcp__binance__get_position_history → Verify journal accuracy against Binance records and update incorrect pnl, position_time_setup, position_time_closed, position_entry_price, position_avg_close_price
